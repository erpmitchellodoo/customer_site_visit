# Customer Site Visits — Odoo 18

Source port from the Odoo 19 module. Technical name remains customer_site_visit.
Manifest version: 18.0.1.0.0. Author, maintainer, support, icon, banner and
description assets are preserved. Listing text identifies Odoo 18.

## Compatibility changes

- Menu and test user group fields use groups_id.
- Dashboard JavaScript includes the explicit @odoo-module marker.
- Retains native list views, card kanban templates, chatter and check_access.
...
Add the parent odoo18 folder to your Odoo 18 addons_path (or copy this module
